...
Track.create(user_id: 1, name: "Tester Track - Inspire 9", address: "43 Stewart St, Richmond", latitude: 37.8238, longitude: 144.9892)
...
Gruppetto.create(name: "Bike Race 1", track_id: 6, user_id: 1, start: Time.now + 5,
